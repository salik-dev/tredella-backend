...
const checkUser = catchAsync(async (req, res) => {
  ...
  console.log(data);
  let use = null;
  let check = await generalService.getRecord(modelName, {
    email: data.email,
...
const signUp = catchAsync(async (req, res) => {
  ...
  const user = await generalService.addRecord(modelName, {fullName, userName, email, phoneNumber, password, platForm, status, role});
...
const forgetPassword = catchAsync(async (req, res) => {
  ...
  const Record = await generalService.getRecord(modelName, {
    email: email,
  });
...
const changePassword = catchAsync(async (req, res) => {
  ...
  const checkPassword = await generalService.getRecord(modelName, {
    _id: user._id,
  });
...
const addUser = catchAsync(async (req, res) => {
  ...
  let Record = await generalService.addRecord(modelName, data);
...
const getProfile = catchAsync(async (req, res) => {
  ...
  // ];
  // let Record = await generalService.getRecordAggregate(modelName, aggregateArr);
  const data = await generalService.getRecordAndSort(modelName, condition)
...
const deleteRecord = catchAsync(async (req, res) => {
  ...
  const Record = await generalService.deleteRecord(modelName, {
    _id: id,
  });
